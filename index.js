...
// function setTime(){
//     var optionValue1 = document.getElementById('wakeup-time').value;
//     var optionValue2 = document.getElementById('lunch-time').value;
//     var optionValue3 = document.getElementById('nap-time').value;
//     var optionValue4 = document.getElementById('night-time').value;
